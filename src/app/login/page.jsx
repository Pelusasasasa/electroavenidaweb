...
export default function page(){
  return (
    <section id='login' className='flex flex-col items-center w-full container pb-20 '>
            ...
            <main className='mt-2 self-end  border-b-customGray border-b-8 border-l-customGray border-l-8'>
                ...
                <div className='flex flex-col mt-14 gap-5'>
                    <input type="email" name="email" id="email" placeholder='E-mail' className='self-center text-xl'/>
                    <input type="password" name="password" id="password" placeholder='Password' className='self-center text-xl'/>

                    <button className='text-customGray text-3xl font-bold self-center px-4 py-2'>Iniciar Sesion</button>
